...
TEST_F(FoundSameTest, check_eq_progs) {
    foundSame->setData({ {"a", {1, 0}}, {"a", {2, 0}}, {"a", {3, 0}} },
                       { {"a", {1, 0}}, {"a", {2, 0}}, {"a", {3, 0}} });

    std::pair <std::string, std::string> res = foundSame->getTexts();
    std::pair <std::string, std::string> exp_res = {"<!DOCTYPE html>\n"
                                                    "<html lang=\"en\">\n"
...
TEST_F(FoundSameTest, check_progs_with_delete) {
    foundSame->setData({ {"a", {1, 0}}, {"d", {2, 0}}, {"a", {3, 0}} },
                       { {"a", {1, 0}}, {"a", {3, 0}} });
    ...
    std::pair <std::string, std::string> exp_res = {"<!DOCTYPE html>\n"
                                                    ...
                                                    "<!DOCTYPE html>\n"
                                                    "<html lang=\"en\">\n"
                                                    "<div><span style=\"background-color: #96CC9F\">a </span><span style=\"background-color: #CD5C5C\"></span><br>\n"
                                                    "<br>\n"
                                                    "<span></span><span style=\"background-color: #96CC9F\">a </span></div>\n"
                                                    "</html>"};
    EXPECT_EQ(res, exp_res);
